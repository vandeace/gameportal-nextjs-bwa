            ...
            <div className="col-lg-6 col-12 d-lg-block d-none">
              ...
              <div className="d-flex justify-content-lg-end justify-content-center me-lg-5">
                ...
                <div className="position-relative" data-aos="zoom-in">
                  <img src="/Header-1.png" className="img-fluid" alt="data" />
                  ...
                  <div className="card right-card position-absolute border-0">
                    <div className="position-relative d-flex flex-row justify-content-center mb-24">
                      <img src="/Header-3.png" className="rounded-pill" alt="" />
        ...
        <div className="container-fluid">
          ...
          <div
            ...
            <div className="featured-game-card position-relative">
              <a href="./src/detail.html">
                <div className="blur-sharp">
                  <img src="/Thumbnail-1.png" width="205" height="270" alt="" />
                </div>
            ...
            <div className="featured-game-card position-relative">
              <a href="./src/detail.html">
                <div className="blur-sharp">
                  <img src="/Thumbnail-3.png" width="205" height="270" alt="" />
                </div>
                <div className="cover position-absolute bottom-0 m-32">
                  <div className="d-flex flex-column h-100 justify-content-between text-decoration-none">
                    <div className="game-icon mx-auto">
            ...
            <div className="featured-game-card position-relative">
              <a href="./src/detail.html">
                <div className="blur-sharp">
                  <img src="/Thumbnail-4.png" width="205" height="270" alt="" />
                </div>
                <div className="cover position-absolute bottom-0 m-32">
                  <div className="d-flex flex-column h-100 justify-content-between text-decoration-none">
                    <div className="game-icon mx-auto">
            ...
            <div className="featured-game-card position-relative">
              <a href="./src/detail.html">
                <div className="blur-sharp">
                  <img src="/Thumbnail-5.png" width="205" height="270" alt="" />
                </div>
                <div className="cover position-absolute bottom-0 m-32">
                  <div className="d-flex flex-column h-100 justify-content-between text-decoration-none">
                    <div className="game-icon mx-auto">
        ...
        <div className="container-xxl container-fluid">
          <div className="row align-items-center px-lg-5 mx-auto gap-lg-0 gap-4">
            <div className="col-lg-7 col-12 d-lg-flex d-none justify-content-lg-end pe-lg-60" data-aos="zoom-in">
              <img src="/Header-9.png" width="612" height="452" className="img-fluid" alt="" />
            </div>
                    ...
                    <ul className="list-unstyled">
                      <li className="mb-6">
                        <a
                          ...
                          className="text-lg color-palette-1 text-decoration-none">hi@store.gg
                        </a>
                      </li>
                      <li className="mb-6">
                        <a
